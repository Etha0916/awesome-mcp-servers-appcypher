...
- <img src="https://api.iconify.design/mdi:chart-line-variant.svg?color=%232dd4bf" height="14"/> [Praesentire](https://github.com/Etha0916/praesentire-mcp) - Bilingual (English + Traditional Chinese) financial news sentiment scored by Claude. Three tools: `get_sentiment`, `get_sentiment_batch`, `compare_languages` (bilingual divergence as cross-market signal).
...
- <img src="https://vulert.com/favicon.ico" height="14"> [Vulert](vulert.com) - Vulert secures software by detecting vulnerabilities in open-source dependencies—without accessing your code. It supports Js, PHP, Java, Python, and more
